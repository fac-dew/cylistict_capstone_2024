...
# Combining dataset, no need to run this in GitHub 
setwd(".../Dataset/Clean Cyclist Data")
clean_list <- list.files(pattern = "*.csv")
clean_list <- lapply(clean_list, read.csv)
combined_clean_data <- do.call(rbind, clean_list)
```
